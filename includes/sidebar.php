...
if ($roleId === ROLE_SUPER_ADMIN) {
    ...
    $menus = [
        ...
        ['section' => 'SCOLARITE'],
        ['url'=>'/admin/academic-structure.php', 'icon'=>'bx-sitemap', 'label'=>'Structure academique', 'key'=>'academic-structure'],
    ...
    $menus = [
        ...
        ['url'=>'/teachers/courses.php',    'icon'=>'bx-book-open',    'label'=>'Mes cours',       'key'=>'courses'],
        ['section' => 'COMMUNICATION'],
