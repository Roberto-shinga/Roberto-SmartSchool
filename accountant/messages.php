...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'send') {
        ...
        if (!$receiverId || empty($subject) || empty($body)) {
            ...
            createNotification($receiverId, 'Nouveau message : ' . $subject, mb_substr($body, 0, 100), 'info', BASE_URL . '/accountant/messages.php');
      ...
      <div class="card">
        ...
        <div style="max-height:560px;overflow-y:auto">
          ...
          <?php else: foreach ($conversations as $c): ?>
            <a href="<?= BASE_URL ?>/accountant/messages.php?with=<?= $c['other_id'] ?>"
